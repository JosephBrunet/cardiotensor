...
def export_vector_field_to_vtk(
    ...
    # Apply display/export downsampling
    print(f"Downsampling vector field with factor={downsample}...")

    vector_field = vector_field[::downsample, ::downsample, ::downsample, :]
    color_volume = color_volume[::downsample, ::downsample, ::downsample]
    ...
    writeStructuredVTK(
        aspectRatio=[voxel_size * downsample] * 3,
        origin=[0.0, 0.0, 0.0],
        cellData=cellData,
